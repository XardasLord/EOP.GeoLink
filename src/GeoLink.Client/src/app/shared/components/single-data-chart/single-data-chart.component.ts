...
export class SingleDataChartComponent implements OnInit, OnDestroy {
  @Input() public chartType!: ChartTypeEnum;
  @Input() public chartModel!: ChartModel;
  ...
  ngOnInit(): void {
    ...
    console.warn(this.chartModel);
    this.prepareChart(this.chartModel);
